...
class Header(Funcs):
    ...
    def header(self, canvas, doc):
        ...
        if Pages.listaCli_imagePath_logo == '':
            # if user didn't import an image to represent logo
            right_head_Image = Image(r"header_image_mockup1920_838.png",
                                     2.8 * inch, 2.8 * inch, kind='proportional')
        else:  # size of image
...
class Application(FuncInDBGen, EegPdfReport, Funcs, ToolTip):
    ...
    # def clear_entry_aba1(self):
    #     cleaning =  self.abas.select(self.aba1)
    #     cleaning.patient_entry.delete(0, 'end')
    #     cleaning.age_entry.delete(0, 'end')
    #     cleaning.Id_entry.delete(0, 'end')
    #     cleaning.diag_entry.delete(0, 'end')
    #     cleaning.LFF_entry.delete(0, 'end')
    #     cleaning.HFF_entry.delete(0, 'end')
    #     cleaning.srate_entry.delete(0, 'end')
